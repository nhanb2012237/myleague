  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'spin-slower': 'spinSlower 3s linear infinite',
        'spin-reverse': 'spinSlower 1.5s linear infinite reverse',
      ...
      boxShadow: {
        ...
        boxShadow: '0 4px 4px 0 rgba(#303030, 0.15)',
      },
      backgroundImage: {
        ballanceDashboard: "url('/src//public/img/dashboards/balanceImg.png')",
        ellispisModeCarInterface:
...
// const withMT = require('@material-tailwind/react/utils/withMT'); // Import the withMT function dùng cho Material Tailwind
