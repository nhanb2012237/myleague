...
//       }}
//       className="relative flex min-h-screen w-full overflow-y-auto bg-cover bg-center bg-no-repeat"
//     >
...
function Default(props: { maincard: JSX.Element }) {
  ...
  return (
    <div
      ...
      className="fixed inset-0 flex h-full w-full bg-cover bg-center bg-no-repeat"
    >
      <div className="mx-auto flex min-h-screen w-full flex-col justify-start pt-12 md:max-w-[75%] lg:max-w-[1013px] lg:px-8 lg:pt-0 xl:max-w-[1383px] xl:px-0 xl:pl-[70px]">
        <div className="mb-auto flex flex-col pl-5 pr-5 md:pl-12 md:pr-0 lg:max-w-[48%] lg:pl-0 xl:max-w-full">
          {maincard}
          <div className="absolute right-0 hidden h-full min-h-screen md:block lg:w-[49vw] 2xl:w-[44vw]">
